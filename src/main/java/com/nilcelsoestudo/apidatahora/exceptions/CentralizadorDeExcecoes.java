package com.nilcelsoestudo.apidatahora.exceptions;
...
public class CentralizadorDeExcecoes {
    ...
    public Erro handZoneRulesException(ZoneRulesException e) {
        return buildErro(new RuntimeException("Por favor, forneça timezone válido"));
    }
    @ExceptionHandler(DateTimeException.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public Erro handZoneRulesException(DateTimeException e) {
